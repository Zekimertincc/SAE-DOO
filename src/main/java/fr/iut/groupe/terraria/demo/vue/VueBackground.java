...
public class VueBackground extends Pane {
    ...
    public VueBackground(int largeurCartePx, double largeurEcran, double hauteurEcran) {
        ...
        genererCalque(calqueArriere, "/fr/iut/groupe/terraria/demo/images/background_arriere.png", largeurCartePx, largeurEcran, hauteurEcran);
        genererCalque(calqueMilieu,  "/fr/iut/groupe/terraria/demo/images/background_milieu.png", largeurCartePx, largeurEcran, hauteurEcran);
        genererCalque(calqueAvant,   "/fr/iut/groupe/terraria/demo/images/background_avant.png", largeurCartePx, largeurEcran, hauteurEcran);
